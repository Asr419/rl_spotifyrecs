...
SPOTIPY_REDIRECT_URI = os.getenv(
    "SPOTIPY_REDIRECT_URI_CALLBACK"
)  # This should match the one you set in your Spotify Developer Application
...
for user in Users:
    ...
    if current_track is not None:
        ...
        print(
            f"User {user} is listening to {current_track['item']['name']} by {current_track['item']['artists'][0]['name']}"
        )
